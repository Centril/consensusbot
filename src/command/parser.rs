...
/// Parser recognizing an `unhold` command.
/// Example: `@rfcbot unhold`.
command!(unhold(), Command::Unhold,
    ["unholding"] ["unholds"] ["unheld"] [report "unhold"]);
...
mod test {
    ...
    test_from_str!(success_unhold, Command::Unhold,
        ["unhold", "unholds", "unheld", "unholding"]);
